...
func (e PositionEdges) EmployeeOrErr() ([]*Employee, error) {
	if e.loadedTypes[0] {
...
// QueryEmployee queries the employee edge of the Position.
func (po *Position) QueryEmployee() *EmployeeQuery {
	return (&PositionClient{config: po.config}).QueryEmployee(po)
}
